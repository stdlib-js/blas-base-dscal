...
```javascript
dscal = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-dscal@v0.3.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-dscal@v0.3.0-umd/browser.js"></script>
```
