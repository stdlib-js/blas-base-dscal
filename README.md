...
```javascript
import dscal from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-dscal@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/blas-base-dscal/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/blas-base-dscal/actions/workflows/test.yml?query=branch:v0.1.1
